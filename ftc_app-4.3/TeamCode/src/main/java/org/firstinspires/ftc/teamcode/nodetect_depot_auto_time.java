...
public class nodetect_depot_auto_time extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //drive forward, knock off the center mineral, and go to the depot
        drivetrain.timedDrive(3, 1, 0, 0, 1);
